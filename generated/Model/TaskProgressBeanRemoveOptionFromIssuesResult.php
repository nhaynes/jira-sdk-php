...
class TaskProgressBeanRemoveOptionFromIssuesResult
{
     ...
     *
     * @var TaskProgressBeanRemoveOptionFromIssuesResultResult
     */
    protected $result;
    /**
     ...
     * The result of the task execution.
     *
     * @return TaskProgressBeanRemoveOptionFromIssuesResultResult
     */
    public function getResult(): TaskProgressBeanRemoveOptionFromIssuesResultResult
    {
        return $this->result;
    }
    /**
     * The result of the task execution.
     *
     * @param TaskProgressBeanRemoveOptionFromIssuesResultResult $result
     *
     * @return self
     */
    public function setResult(TaskProgressBeanRemoveOptionFromIssuesResultResult $result): self
    {
