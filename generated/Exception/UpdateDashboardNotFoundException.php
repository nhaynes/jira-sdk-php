...
class UpdateDashboardNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('Returned if the dashboard is not found or the dashboard is not owned by the user.');
