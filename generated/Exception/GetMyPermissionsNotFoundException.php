...
class GetMyPermissionsNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('Returned if the project or issue is not found or the user does not have permission to view the project or issue.');
