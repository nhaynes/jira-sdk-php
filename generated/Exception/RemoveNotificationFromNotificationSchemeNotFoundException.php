...
class RemoveNotificationFromNotificationSchemeNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('Returned if either the notification scheme or notification isn\'t found.');
