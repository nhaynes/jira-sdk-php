...
class RemoveIssueTypesFromGlobalFieldConfigurationSchemeNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('Returned if the field configuration scheme or the issue types are not found.');
