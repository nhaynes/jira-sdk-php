...
class GetAvatarImageByOwnerNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('Returned if an avatar is not found or an avatar matching the requested size is not found.');
