...
class RemoveIssueTypesFromGlobalFieldConfigurationSchemeForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('Returned if the user does not have the necessary permission.');
