...
class UpdateWorkflowTransitionRuleConfigurationsForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('Returned if the caller is not a Connect app.');
