...
class BulkSetIssuePropertiesByIssueForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('Return if the user does not have the necessary permission.');
