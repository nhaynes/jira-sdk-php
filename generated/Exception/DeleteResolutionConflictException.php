...
class DeleteResolutionConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('Returned if a task to delete the issue resolution is already running.');
