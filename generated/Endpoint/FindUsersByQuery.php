...
class FindUsersByQuery extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \JiraSdk\Exception\FindUsersByQueryBadRequestException($response);
        }
        if (401 === $status) {
            throw new \JiraSdk\Exception\FindUsersByQueryUnauthorizedException($response);
        }
        if (403 === $status) {
            throw new \JiraSdk\Exception\FindUsersByQueryForbiddenException($response);
        }
        if (408 === $status) {
            throw new \JiraSdk\Exception\FindUsersByQueryRequestTimeoutException($response);
        }
    }
