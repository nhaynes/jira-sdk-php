...
class GetAllPermissionSchemes extends \JiraSdk\Api\Runtime\Client\BaseEndpoint implements \JiraSdk\Api\Runtime\Client\Endpoint
{
     ...
     * {@inheritdoc}
     *
     * @return \JiraSdk\Api\Model\PermissionSchemes|null
     *
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ((null === $contentType) === false && (200 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            return $serializer->deserialize($body, 'JiraSdk\\Api\\Model\\PermissionSchemes', 'json');
        }
        if (401 === $status) {
            throw new \JiraSdk\Api\Exception\GetAllPermissionSchemesUnauthorizedException($response);
        }
    }
}
