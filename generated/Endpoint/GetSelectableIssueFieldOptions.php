...
class GetSelectableIssueFieldOptions extends \JiraSdk\Api\Runtime\Client\BaseEndpoint implements \JiraSdk\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{fieldKey}'], [$this->fieldKey], '/rest/api/3/field/{fieldKey}/option/suggestions/edit');
    }
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \JiraSdk\Api\Exception\GetSelectableIssueFieldOptionsUnauthorizedException($response);
        }
        if (404 === $status) {
            throw new \JiraSdk\Api\Exception\GetSelectableIssueFieldOptionsNotFoundException($response);
        }
    }
}
