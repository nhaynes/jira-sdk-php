...
class GetCreateIssueMeta extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('projectIds', 'projectKeys', 'issuetypeIds', 'issuetypeNames', 'expand'));
        $optionsResolver->setRequired(array());
        $optionsResolver->setDefaults(array());
        $optionsResolver->addAllowedTypes('projectIds', array('array'));
        $optionsResolver->addAllowedTypes('projectKeys', array('array'));
        $optionsResolver->addAllowedTypes('issuetypeIds', array('array'));
        $optionsResolver->addAllowedTypes('issuetypeNames', array('array'));
     ...
     *
     * @return null|\JiraSdk\Model\IssueCreateMetadata
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'JiraSdk\\Model\\IssueCreateMetadata', 'json');
        }
        if (401 === $status) {
            throw new \JiraSdk\Exception\GetCreateIssueMetaUnauthorizedException($response);
        }
    }
