...
class GetAllIssueFieldOptions extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \JiraSdk\Exception\GetAllIssueFieldOptionsBadRequestException($response);
        }
        if (403 === $status) {
            throw new \JiraSdk\Exception\GetAllIssueFieldOptionsForbiddenException($response);
        }
    }
