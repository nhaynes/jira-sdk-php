...
class SearchForIssuesUsingJql extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('jql', 'startAt', 'maxResults', 'validateQuery', 'fields', 'expand', 'properties', 'fieldsByKeys'));
        $optionsResolver->setRequired(array());
        $optionsResolver->setDefaults(array('startAt' => 0, 'maxResults' => 50, 'validateQuery' => 'strict', 'fieldsByKeys' => false));
        ...
        $optionsResolver->addAllowedTypes('validateQuery', array('string'));
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \JiraSdk\Exception\SearchForIssuesUsingJqlBadRequestException($response);
        }
        if (401 === $status) {
            throw new \JiraSdk\Exception\SearchForIssuesUsingJqlUnauthorizedException($response);
        }
    }
