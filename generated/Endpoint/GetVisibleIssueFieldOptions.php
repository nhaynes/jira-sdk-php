...
class GetVisibleIssueFieldOptions extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{fieldKey}'), array($this->fieldKey), '/rest/api/3/field/{fieldKey}/option/suggestions/search');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefaults(array('startAt' => 0));
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \JiraSdk\Exception\GetVisibleIssueFieldOptionsUnauthorizedException($response);
        }
        if (404 === $status) {
            throw new \JiraSdk\Exception\GetVisibleIssueFieldOptionsNotFoundException($response);
        }
    }
