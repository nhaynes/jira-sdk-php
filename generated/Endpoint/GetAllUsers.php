...
class GetAllUsers extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \JiraSdk\Exception\GetAllUsersBadRequestException($response);
        }
        if (403 === $status) {
            throw new \JiraSdk\Exception\GetAllUsersForbiddenException($response);
        }
        if (409 === $status) {
            throw new \JiraSdk\Exception\GetAllUsersConflictException($response);
        }
    }
