...
class UpdateIssueFieldOption extends \JiraSdk\Api\Runtime\Client\BaseEndpoint implements \JiraSdk\Api\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $fieldKey, int $optionId, \JiraSdk\Api\Model\IssueFieldOption $requestBody)
    {
    ...
    {
        if ($this->body instanceof \JiraSdk\Api\Model\IssueFieldOption) {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \JiraSdk\Api\Exception\UpdateIssueFieldOptionBadRequestException($response);
        }
        if (403 === $status) {
            throw new \JiraSdk\Api\Exception\UpdateIssueFieldOptionForbiddenException($response);
        }
        if (404 === $status) {
            throw new \JiraSdk\Api\Exception\UpdateIssueFieldOptionNotFoundException($response);
        }
    }
}
