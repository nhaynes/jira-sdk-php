...
class AddAttachment extends \JiraSdk\Runtime\Client\BaseEndpoint implements \JiraSdk\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(array('{issueIdOrKey}'), array($this->issueIdOrKey), '/rest/api/3/issue/{issueIdOrKey}/attachments');
    }
     ...
     *
     * @return null|\JiraSdk\Model\Attachment[]
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'JiraSdk\\Model\\Attachment[]', 'json');
        }
        if (403 === $status) {
            throw new \JiraSdk\Exception\AddAttachmentForbiddenException($response);
        }
        if (404 === $status) {
            throw new \JiraSdk\Exception\AddAttachmentNotFoundException($response);
        }
        if (413 === $status) {
            throw new \JiraSdk\Exception\AddAttachmentRequestEntityTooLargeException($response);
        }
    }
