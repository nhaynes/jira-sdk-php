...
class GroupNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JiraSdk\\Model\\Group';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'JiraSdk\\Model\\Group';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \JiraSdk\Model\Group();
        ...
        if (\array_key_exists('users', $data)) {
            $object->setUsers($this->denormalizer->denormalize($data['users'], 'JiraSdk\\Model\\GroupUsers', 'json', $context));
        }
