...
class ComponentWithIssueCountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\ComponentWithIssueCount' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\ComponentWithIssueCount' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\ComponentWithIssueCount();
        ...
        if (\array_key_exists('realAssignee', $data)) {
            $object->setRealAssignee($this->denormalizer->denormalize($data['realAssignee'], 'JiraSdk\\Api\\Model\\ComponentWithIssueCountRealAssignee', 'json', $context));
        }
        ...
        if (\array_key_exists('assignee', $data)) {
            $object->setAssignee($this->denormalizer->denormalize($data['assignee'], 'JiraSdk\\Api\\Model\\ComponentWithIssueCountAssignee', 'json', $context));
        }
        ...
        if (\array_key_exists('lead', $data)) {
            $object->setLead($this->denormalizer->denormalize($data['lead'], 'JiraSdk\\Api\\Model\\ComponentWithIssueCountLead', 'json', $context));
        }
