...
class TaskProgressBeanRemoveOptionFromIssuesResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JiraSdk\\Model\\TaskProgressBeanRemoveOptionFromIssuesResult';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'JiraSdk\\Model\\TaskProgressBeanRemoveOptionFromIssuesResult';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \JiraSdk\Model\TaskProgressBeanRemoveOptionFromIssuesResult();
        ...
        if (\array_key_exists('result', $data)) {
            $object->setResult($this->denormalizer->denormalize($data['result'], 'JiraSdk\\Model\\TaskProgressBeanRemoveOptionFromIssuesResultResult', 'json', $context));
        }
