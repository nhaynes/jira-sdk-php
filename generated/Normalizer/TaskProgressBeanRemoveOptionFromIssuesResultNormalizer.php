...
class TaskProgressBeanRemoveOptionFromIssuesResultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return 'JiraSdk\\Api\\Model\\TaskProgressBeanRemoveOptionFromIssuesResult' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\TaskProgressBeanRemoveOptionFromIssuesResult' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\TaskProgressBeanRemoveOptionFromIssuesResult();
        ...
        if (\array_key_exists('result', $data)) {
            $object->setResult($this->denormalizer->denormalize($data['result'], 'JiraSdk\\Api\\Model\\TaskProgressBeanRemoveOptionFromIssuesResultResult', 'json', $context));
        }
