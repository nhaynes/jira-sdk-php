...
class CreateWorkflowTransitionRulesDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionRulesDetails' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionRulesDetails' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\CreateWorkflowTransitionRulesDetails();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('conditions', $data)) {
            $object->setConditions($this->denormalizer->denormalize($data['conditions'], 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionRulesDetailsConditions', 'json', $context));
        }
        if (\array_key_exists('validators', $data)) {
            $values = [];
            foreach ($data['validators'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionRule', 'json', $context);
            }
        ...
        if (\array_key_exists('postFunctions', $data)) {
            ...
            foreach ($data['postFunctions'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionRule', 'json', $context);
            }
