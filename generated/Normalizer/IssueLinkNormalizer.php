...
class IssueLinkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\IssueLink' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\IssueLink' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\IssueLink();
        ...
        if (\array_key_exists('inwardIssue', $data)) {
            $object->setInwardIssue($this->denormalizer->denormalize($data['inwardIssue'], 'JiraSdk\\Api\\Model\\IssueLinkInwardIssue', 'json', $context));
        }
        if (\array_key_exists('outwardIssue', $data)) {
            $object->setOutwardIssue($this->denormalizer->denormalize($data['outwardIssue'], 'JiraSdk\\Api\\Model\\IssueLinkOutwardIssue', 'json', $context));
        }
