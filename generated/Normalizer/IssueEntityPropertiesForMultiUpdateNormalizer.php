...
class IssueEntityPropertiesForMultiUpdateNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\IssueEntityPropertiesForMultiUpdate' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\IssueEntityPropertiesForMultiUpdate' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\IssueEntityPropertiesForMultiUpdate();
        ...
        if (\array_key_exists('properties', $data)) {
            ...
            foreach ($data['properties'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'JiraSdk\\Api\\Model\\JsonNode', 'json', $context);
            }
