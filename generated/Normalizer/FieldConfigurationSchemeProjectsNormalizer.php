...
class FieldConfigurationSchemeProjectsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\FieldConfigurationSchemeProjects' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\FieldConfigurationSchemeProjects' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\FieldConfigurationSchemeProjects();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('fieldConfigurationScheme', $data)) {
            $object->setFieldConfigurationScheme($this->denormalizer->denormalize($data['fieldConfigurationScheme'], 'JiraSdk\\Api\\Model\\FieldConfigurationScheme', 'json', $context));
        }
