...
class RemoteIssueLinkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JiraSdk\\Model\\RemoteIssueLink';
    }
    public function supportsNormalization($data, $format = null): bool
    {
        return is_object($data) && get_class($data) === 'JiraSdk\\Model\\RemoteIssueLink';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \JiraSdk\Model\RemoteIssueLink();
        ...
        if (\array_key_exists('application', $data)) {
            $object->setApplication($this->denormalizer->denormalize($data['application'], 'JiraSdk\\Model\\RemoteIssueLinkApplication', 'json', $context));
        }
        if (\array_key_exists('relationship', $data)) {
            $object->setRelationship($data['relationship']);
        }
        if (\array_key_exists('object', $data)) {
            $object->setObject($this->denormalizer->denormalize($data['object'], 'JiraSdk\\Model\\RemoteIssueLinkObject', 'json', $context));
        }
        return $object;
    }
    /**
