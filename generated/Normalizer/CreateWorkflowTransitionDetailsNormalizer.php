...
class CreateWorkflowTransitionDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionDetails' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionDetails' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\CreateWorkflowTransitionDetails();
        ...
        if (\array_key_exists('rules', $data)) {
            $object->setRules($this->denormalizer->denormalize($data['rules'], 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionDetailsRules', 'json', $context));
        }
        if (\array_key_exists('screen', $data)) {
            $object->setScreen($this->denormalizer->denormalize($data['screen'], 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionDetailsScreen', 'json', $context));
        }
