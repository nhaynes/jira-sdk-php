...
class WorkflowTransitionRulesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\WorkflowTransitionRules' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\WorkflowTransitionRules' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\WorkflowTransitionRules();
        ...
        if (\array_key_exists('postFunctions', $data)) {
            ...
            foreach ($data['postFunctions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JiraSdk\\Api\\Model\\ConnectWorkflowTransitionRule', 'json', $context);
            }
        ...
        if (\array_key_exists('conditions', $data)) {
            ...
            foreach ($data['conditions'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'JiraSdk\\Api\\Model\\ConnectWorkflowTransitionRule', 'json', $context);
            }
        ...
        if (\array_key_exists('validators', $data)) {
            ...
            foreach ($data['validators'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'JiraSdk\\Api\\Model\\ConnectWorkflowTransitionRule', 'json', $context);
            }
