...
class IssueTypeScreenSchemesProjectsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\IssueTypeScreenSchemesProjects' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\IssueTypeScreenSchemesProjects' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\IssueTypeScreenSchemesProjects();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('issueTypeScreenScheme', $data)) {
            $object->setIssueTypeScreenScheme($this->denormalizer->denormalize($data['issueTypeScreenScheme'], 'JiraSdk\\Api\\Model\\IssueTypeScreenSchemesProjectsIssueTypeScreenScheme', 'json', $context));
        }
