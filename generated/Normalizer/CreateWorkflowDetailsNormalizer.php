...
class CreateWorkflowDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\CreateWorkflowDetails' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\CreateWorkflowDetails' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\CreateWorkflowDetails();
        ...
        if (\array_key_exists('transitions', $data)) {
            ...
            foreach ($data['transitions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JiraSdk\\Api\\Model\\CreateWorkflowTransitionDetails', 'json', $context);
            }
        ...
        if (\array_key_exists('statuses', $data)) {
            ...
            foreach ($data['statuses'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'JiraSdk\\Api\\Model\\CreateWorkflowStatusDetails', 'json', $context);
            }
