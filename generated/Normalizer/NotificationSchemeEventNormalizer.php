...
class NotificationSchemeEventNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\NotificationSchemeEvent' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\NotificationSchemeEvent' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\NotificationSchemeEvent();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('event', $data)) {
            $object->setEvent($this->denormalizer->denormalize($data['event'], 'JiraSdk\\Api\\Model\\NotificationEvent', 'json', $context));
        }
        if (\array_key_exists('notifications', $data)) {
            $values = [];
            foreach ($data['notifications'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JiraSdk\\Api\\Model\\EventNotification', 'json', $context);
            }
