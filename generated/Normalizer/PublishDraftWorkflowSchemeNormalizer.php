...
class PublishDraftWorkflowSchemeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JiraSdk\\Api\\Model\\PublishDraftWorkflowScheme' === $type;
    }

    public function supportsNormalization($data, $format = null): bool
    {
        return \is_object($data) && 'JiraSdk\\Api\\Model\\PublishDraftWorkflowScheme' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \JiraSdk\Api\Model\PublishDraftWorkflowScheme();
        ...
        if (\array_key_exists('statusMappings', $data)) {
            ...
            foreach ($data['statusMappings'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'JiraSdk\\Api\\Model\\StatusMapping', 'json', $context);
            }
